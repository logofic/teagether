        ...
        <div className="container">
          <header className="header">
            <div className="logo-container">
              <img src={require('../img/teaicon.png')} alt="teaIcon" className="logo-img" />
          ...
          <div className="content-container">
            <div className="active-users-panel" id="active-user-container">
              <h2 className="panel-title"> <span role="img" aria-label="sheep">🎈</span> ongoing tea parties <span role="img" aria-label="sheep">🎈</span></h2>
            </div>
